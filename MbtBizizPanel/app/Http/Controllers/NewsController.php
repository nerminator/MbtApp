    ...
    private function updateImages(Request $request, int $newsId, string $redirect  ){
        ...
        for ( ; $i < 10; $i++) {
            ...
            if (!empty($imageString)) {
                    ...
                    if (   str_contains($imageString, 'https://bizizapp.com/') 
                        || str_contains($imageString, 'https://biziapp-test.app.daimlertruck.com/') 
                        || str_contains($imageString, 'localhost')
                        || str_contains($imageString, '95.214.97.107') 
                        || str_contains($imageString, '95.214.97.108')) { //already URL
                        ...
                        $projectUrl = app()->environment() == "production" ? "https://biziapp-test.app.daimlertruck.com/bizizPanel/public" : "http://95.214.97.107/bizizPanel/public";
    ...
    private function updatePdfFiles(Request $request, int $newsId, string $redirect  ){
        ...
        for ( ; $i < 10; $i++) {
            ...
            if (!empty($pdfFile)) {
                    ...
                    if (  str_contains($pdfFile, 'https://biziapp-test.app.daimlertruck.com/') 
                       || str_contains($pdfFile, 'localhost')
                       || str_contains($pdfFile, '95.214.97.107'))
                    {
                        $url = $pdfFile;
                    } else {
