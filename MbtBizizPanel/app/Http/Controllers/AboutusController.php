...
class AboutusController extends Controller
{
    ...
    {
        $aboutUsTRHtml = file_get_contents("https://bizizapp.com/bizizPanel/public/storage/aboutusTR.html");
        $aboutUsENHtml = file_get_contents("https://bizizapp.com/bizizPanel/public/storage/aboutusEN.html");
