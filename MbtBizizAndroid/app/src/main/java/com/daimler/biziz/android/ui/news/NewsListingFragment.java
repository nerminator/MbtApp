...
import com.daimler.biziz.android.adapters.NewsAdapter;
import com.daimler.biziz.android.base.BaseFragment;
import com.daimler.biziz.android.databinding.FragmentNewsListingBinding;
import com.daimler.biziz.android.network.entity.news.News;
import com.daimler.biziz.android.network.entity.news.NewsEntity;
import com.daimler.biziz.android.ui.birthday.BirthdayActivity;
import com.daimler.biziz.android.ui.dialogs.bottomSheetDialog.DiscountTypeBottomSheet;
...
public class NewsListingFragment extends BaseFragment implements DiscountTypeBottomSheet.DiscountSelectCallback, NewsAdapter.NewsItemCallback {
    ...
    private void observe() {
        vmNews.getData().observe(this, newsEntity -> {
