...
import com.daimler.biziz.android.databinding.FragmentTermsandconBinding;
import com.daimler.biziz.android.manager.SharedPreferenceManager;
import com.daimler.biziz.android.ui.about.AboutDetailFragment;
import com.daimler.biziz.android.ui.dialogs.MessageDialog;
import com.daimler.biziz.android.uiControls.CustomScrollView.ScrollViewCustom;
import com.daimler.biziz.android.uiControls.CustomScrollView.ScrollViewListener;
...
public class TermsAndConFragment extends Fragment {
    ...
    private void setWebView() {
        ...
        //Spanned sadas = Html.fromHtml(str);
        //binding.tvDescTerms.setText(sadas);
    ...
    private void setListener() {
        ...
        binding.scrollViewTerms.setScrollViewListener(new ScrollViewListener() {
            @Override
            public void onScrollChanged(ScrollViewCustom scrollView, int x, int y, int oldx, int oldy) {
