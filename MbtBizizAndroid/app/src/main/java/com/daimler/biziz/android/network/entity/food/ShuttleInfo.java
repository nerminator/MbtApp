...
public class ShuttleInfo implements Parcelable {
    ...
    public List<com.daimler.biziz.android.network.entity.food.ShuttleList> getShuttleList() {
        return ShuttleList;
    }

    public void setShuttleList(List<com.daimler.biziz.android.network.entity.food.ShuttleList> shuttleList) {
    ...
    protected ShuttleInfo(Parcel in) {
        ...
        this.ShuttleList = in.createTypedArrayList(com.daimler.biziz.android.network.entity.food.ShuttleList.CREATOR);
    }
