...
import com.daimler.biziz.android.databinding.ActivityFlexibleWorkingBinding;
...
import com.daimler.biziz.android.ui.main.orchestra.flexibleWorkingInfo.flexibleHours.FlexibleHourFragment;
...
*/
    ...
    private VMFlexibleWorking viewModel;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of(this).get(VMFlexibleWorking.class);
    ...
    private void observers() {
        ...
        viewModel.getListDay().observe(this, new Observer<ArrayList<FlexibleItemEntity>>() {
            ...
            public void onChanged(@Nullable ArrayList<FlexibleItemEntity> list) {
                FlexibleWorkingDetailActivity.start(FlexibleWorkingActivity.this, detailTitle, list,viewModel.getFlexibleWorkEntity().getValue());
            }
        });
