...
import com.daimler.biziz.android.adapters.WorkCalendarCauseAdapter;
import com.daimler.biziz.android.adapters.WorkingScheduleAdapter;
import com.daimler.biziz.android.base.BaseFragment;
import com.daimler.biziz.android.databinding.FragmentWorkingScheduleBinding;
import com.daimler.biziz.android.model.Day;
import com.daimler.biziz.android.network.entity.workCalendar.DayEntity;
...
public class WorkingScheduleFragment extends BaseFragment {
    ...
    private void observe() {
        vmWorkingSchedule.isLeftButtonClicked.observe(this, (Boolean bool) -> {
            if (bool != null && bool) decreaseMonth();
        });
        vmWorkingSchedule.isRightButtonClicked.observe(this, (Boolean bool) -> {
            if (bool != null && bool) increaseMonth();
        });

        vmWorkingSchedule.getWorkCalendarData().observe(this, this::updateCalendar);
    }
