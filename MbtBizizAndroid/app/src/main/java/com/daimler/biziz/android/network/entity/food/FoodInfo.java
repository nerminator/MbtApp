...
public class FoodInfo implements Parcelable {
    ...
    public List<com.daimler.biziz.android.network.entity.food.FoodList> getFoodList() {
        return FoodList;
    }
    ...
    protected FoodInfo(Parcel in) {
        ...
        this.FoodList = new ArrayList<com.daimler.biziz.android.network.entity.food.FoodList>();
        in.readList(this.FoodList, com.daimler.biziz.android.network.entity.food.FoodList.class.getClassLoader());
