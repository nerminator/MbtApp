...
public class FoodList implements Parcelable {
    ...
    public List<com.daimler.biziz.android.network.entity.food.DetailList> getDetailList() {
        return DetailList;
    }

    public void setDetailList(List<com.daimler.biziz.android.network.entity.food.DetailList> detailList) {
    ...
    protected FoodList(Parcel in) {
        ...
        this.DetailList = new ArrayList<com.daimler.biziz.android.network.entity.food.DetailList>();
        in.readList(this.DetailList, com.daimler.biziz.android.network.entity.food.DetailList.class.getClassLoader());
