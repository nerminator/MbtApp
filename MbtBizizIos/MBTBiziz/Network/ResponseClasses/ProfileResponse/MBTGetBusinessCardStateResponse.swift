...
public final class MBTGetBusinessCardStateResponse: MarshalResponse {
    ...
    public required init(object: MarshaledObject) throws {
      ...
      isActivated = try? object.value(for: SerializationKeys.isActivated)
    ...
    public func dictionaryRepresentation() -> [String: Any] {
      ...
      if let value = isActivated { dictionary[SerializationKeys.isActivated] = value }
