...
{   
    ...
    _locale = [NSLocale localeWithLocaleIdentifier:@"tr_TR"];
...
-(void)scrollToNextPage {
    NSDate *nextPage = [self.gregorian dateByAddingUnit:NSCalendarUnitMonth value:1 toDate:_currentPage options:0];
    [self setCurrentPage:nextPage animated:YES];
}

-(void)scrollToPreviousPage {
    NSDate *previousPage = [self.gregorian dateByAddingUnit:NSCalendarUnitMonth value:-1 toDate:_currentPage options:0];
    [self setCurrentPage:previousPage animated:YES];
}
