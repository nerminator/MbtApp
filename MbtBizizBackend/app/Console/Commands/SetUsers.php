...
class SetUsers extends Command
{
    ...
    private function _setUsers()
    {
        ...
        if (is_array($registerNumberList) && count($registerNumberList) > 0) {
            $testUserIdList = [7697, 7701, 103559, 103560,103642,103715, 103716,103717];
    ...
    {
        $whiteCollarList = ["001 Direktör", "004 Bölüm Müdürü", "006 Kısım Müdürü", "007 Grup Şefi", "009 Memur", "016 Engelli BY", "015 Özürlü/Hükümlü/T", "015 PEP"];
        $blueCollarList = ["010 Postabaşı", "013 Direkt İşçi", "014 Endirekt İşçi", "011 Postabaşı S", "015 Engelli MY"];
